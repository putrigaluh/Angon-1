...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<link rel="stylesheet" type="<?php echo base_url(''); ?>/text/css" href="<?php echo base_url(''); ?>/css/isotope.css" media="screen" />	
		<link rel="stylesheet" href="<?php echo base_url(''); ?>/js/fancybox/jquery.fancybox.css" type="<?php echo base_url(''); ?>/text/css" media="screen" />
		...
		<!-- skin -->
		<link rel="stylesheet" href="<?php echo base_url(''); ?>/skin/default.css">
    </head>
	...
	<section id="header" class="appear">
		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
				...
				<div class="navbar-header">
					...
					<h1><a class="navbar-brand" href="<?php echo base_url(''); ?>/index.html" data-0="line-height:90px;" data-300="line-height:50px;">ANGON
					</a></h1>
				</div>
...
<section class="featured">
				...
				<ul>
					<li>
						<div class="slide-body" data-group="slide">
							<img src="<?php echo base_url(''); ?>/img/8.jpg" alt="">
							<div class="caption header" data-animate="slideAppearUpToDown" data-delay="500" data-length="300">
								<h2>ANGON</h2>
								<div class="caption-sub" data-animate="slideAppearDownToUp" data-delay="1200" data-length="300"><h4><span>Perusahaan ecommerce peternakan di Indonesia</span></h4></div>
  	    		...
  	    		<li>
              <div class="slide-body" data-group="slide">
                <img src="<?php echo base_url(''); ?>/img/6.jpg" alt="">
                <div class="caption header" data-animate="slideAppearUpToDown" data-delay="500" data-length="300">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4>Perusahaan kami berdiri pada tahun 2016 </h4>
								<p>ANGON dalam bahasa jawa berarti mengembala. ANGON merupakan sistem ecommerce yang dapat membantu anda untuk memudahkan bisnis peternakan anda. 
									Kami bertujuan untuk menghubungkan pelaku peternakan di Indonesia. Pelaku peternakan di Indonesia meliputi :</p>
							</div>
							<div class="list-style">
								<div class="row">
									<div class="col-lg-6 col-sm-6 col-xs-12">
										<ul>
											<li>Industri Ternak</li>
											<li>Peternak</li>
											<li>Pengguna Hasil Ternak</li>
				...
				<div class="row mar-bot10">
					...
					<div class="row align-center mar-bot45">
						...
						<div class="wow bounceIn" data-animation-delay="4.8s">
							<div class="team-member">
								<div class="profile-picture">
									<figure><img src="<?php echo base_url(''); ?>/img/members3.jpg" alt=""></figure>
						...
						<div class="col-md-4">
							...
							<div class="team-member">
								<div class="profile-picture">
									<figure><img src="<?php echo base_url(''); ?>/img/members1.jpg" alt=""></figure>
									<div class="profile-overlay"></div>
										<div class="profile-social">
											<div class="icons-wrapper">
												<a href="#"><i class="fa fa-facebook"></i></a>
						...
						<div class="col-md-4">
							...
							<div class="team-member">
								<div class="profile-picture">
									<figure><img src="<?php echo base_url(''); ?>/img/members2.jpg" alt=""></figure>
									<div class="profile-overlay"></div>
										<div class="profile-social">
											<div class="icons-wrapper">
												<a href="#"><i class="fa fa-facebook"></i></a>
                              ...
                              <div class="portfolio-items isotopeWrapper clearfix" id="3">
                                ...
                                <article class="col-md-4 isotopeItem webdesign">
									...
									<div class="wow rotateInUpLeft" data-animation-delay="4.8s">
										<img src="<?php echo base_url(''); ?>/img/portfolio/1.jpg" alt="welcome" />
									</div>
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 1</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/1.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem photography">
									<div class="portfolio-item">
									<div class="wow bounceIn">
										<img src="<?php echo base_url(''); ?>/img/portfolio/2.jpg" alt="" />
									</div>
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 2</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/2.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem photography">
									...
									<div class="wow rotateInDownRight">
										<img src="<?php echo base_url(''); ?>/img/portfolio/3.jpg" alt="" />
									</div>	
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 3</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/3.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem print">
									...
									<div class="wow rotateInUpLeft">
										<img src="<?php echo base_url(''); ?>/img/portfolio/4.jpg" alt="" />
									 </div>	
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 4</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/4.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem photography">
									<div class="portfolio-item">
									<div class="wow bounceIn">
										<img src="<?php echo base_url(''); ?>/img/portfolio/5.jpg" alt="" />
									</div>
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 5</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/5.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem webdesign">
									<div class="portfolio-item">
									<div class="wow rotateInDownRight">
										<img src="<?php echo base_url(''); ?>/img/portfolio/6.jpg" alt="" />
									 </div>		
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 6</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/6.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem print">
									<div class="portfolio-item">
									<div class="wow rotateInUpLeft">
										<img src="<?php echo base_url(''); ?>/img/portfolio/7.jpg" alt="" />
									</div>
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 7</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/7.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem photography">
									<div class="portfolio-item">
									<div class="wow bounceIn">
										<img src="<?php echo base_url(''); ?>/img/portfolio/8.jpg" alt="" />
									</div>	
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 8</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/8.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                ...
                                <article class="col-md-4 isotopeItem print">
									<div class="portfolio-item">
									<div class="wow rotateInDownRight">
										<img src="<?php echo base_url(''); ?>/img/portfolio/9.jpg" alt="" />
									</div>
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="#">Project name 9</a></h5>
												<a href="<?php echo base_url(''); ?>/img/portfolio/9.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
	...
	<script src="<?php echo base_url(''); ?>/js/jquery.parallax-1.1.3.js" type="text/javascript" ></script>
	<script src="<?php echo base_url(''); ?>/js/skrollr.min.js"></script>		
	<script src="<?php echo base_url(''); ?>/js/jquery.scrollTo-1.4.3.1-min.js"></script>
