											...
											<tr>
												...
												<td>
													<div class="margin-bottom-5">
														...
														<a href="<?php echo base_url(); ?>manage/pesanan/detail_pesanan/<?php echo $order->id_transaksi; ?>"><button class="btn btn-sm green filter-submit margin-bottom" ><i class=""></i>Lihat Detail</button></a>
													</div>
