			...
			<div class="row">
				...
				<table class="table table-compare">
					<tr>
						...
						<?php foreach($this->session->userdata('compare') as $items) {
					...
					<tr>
						...
						<?php foreach($this->session->userdata('compare')as $items) {
						 	echo "<td><a href='#'><img src='". base_url($items['image'])."'' alt='thumb product' width='250px' height='200px'></a></td>";
						}?>
					...
					<tr>
						...
						<?php foreach($this->session->userdata('compare') as $items) {
						echo "<td>
							<a href='".base_url()."ecomerce/shoppingcart/buy/".  $items['id'] ."'>
							...
							<a href='".base_url()."ecomerce/compare_produk/delete/". $items['id'] ."'>
