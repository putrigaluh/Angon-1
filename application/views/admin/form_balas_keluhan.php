	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<form  class="form-horizontal form-row-seperated" role="form" action="<?= $this->config->base_url(); ?>admin/keluhan/insert_balas_keluhan/<?php echo $p->id_keluhan?>" method="post" enctype="multipart/form-data"> 
						<div class="portlet">
